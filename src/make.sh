...
$GCC  -std=c++11  -fvisibility=hidden -fvisibility-inlines-hidden   -fopenmp -pthread 	  -g	  -O3      VCF2PCACluster.cpp 	  -lz	  -L/usr/lib/	  -L./include/zlib/	  -L	  /hwfssz4/BC_PUB/Software/01.Usr/lib/	  -o	  ../bin/VCF2PCACluster 	  -lm	  -lc
chmod 755 ../bin/*
